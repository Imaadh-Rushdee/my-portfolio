...
export default function Hero() {
  return (
    <section className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex items-center transition-colors duration-500">
      <div className="container max-w-[1300px] mx-auto flex flex-col md:flex-row items-center px-4 md:px-12">
        ...
        <div className="md:w-1/2 md:pl-[150px] text-center md:text-left">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            I’m a passionate software engineering student who loves building sleek, modern web applications. My focus is on clean design, responsive layouts, and interactive user experiences. Always learning, always improving.
          </p>
